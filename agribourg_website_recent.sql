...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 21 jan. 2023 à 18:11
...
(21, 'Salade batavia BIO', 'salades_batavia.jpg', NULL, 1.63, 1.95, NULL, 1, 'Nos salades batavia BIO aux feuilles fraîches, tendres et craquantes.', '1 pièce d\'environ 345 grammes', 'Cette salade batavia BIO est idéale pour la conception de burger maison. ', NULL, NULL, 1.95, NULL, 2),
...
(25, 'fruits et légumes BIO (2-3 personnes)', 'panier_fruit_legume_moyen.jpg', NULL, 15.42, 18.2, NULL, 1, 'Ce panier est composé de 5 à 8 fruits et légumes de saison BIO et parfois de produits exotiques. ', '1 panier de 4 à 6 kilogrammes', 'Ce panier BIO permet de réaliser des succulentes recettes de saison.', 15, 18.2, 21.5, NULL, 3),
(27, 'fruits et légumes BIO pour grande famille ', 'panier_fruits_legumes_grand.jpg', NULL, 42.5, 51, NULL, 1, 'Notre panier BIO composé de fruits et légumes, de 12 à 15 produits conviendra aux grandes familles. Son poids va de 12 à 15 kilos.', '1 panier de 12 à 15 kilogrammes', 'Ce panier BIO de fruits et légumes conviendra parfaitement pour réaliser des plats en famille et passer des moments conviviaux.', 15, 51, 60, NULL, 3),
(28, 'fruits et légumes BIO pour 1 personne', 'panier_fruits_legumes_individuel.jpg', NULL, 11.25, 13.5, NULL, 1, 'Notre panier composé de 5 à 7 fruits et légumes BIO pèse de 2.5 à 3 kilos. \r\nNos paniers sont constituées de produits de saison. ', '1 panier de 2.5 à 3 kilogrammes', 'Ce panier composé de fruits et légumes BIO conviendra pour une personne pour réaliser des plats équilibré, savoureux et bons pour la santé.', NULL, NULL, 13.5, NULL, 3),
(29, 'fruits BIO (2/3 personnes)\r\n', 'panier_fruit_moyen.jpg', NULL, 18.25, 21.9, NULL, 1, 'Notre panier est composé de fruits de printemps ou d\'été BIO et parfois de fruits exotiques d\'un poids de 5 à 6 kilogrammes.', '1 panier de 4 à 6 kilogrammes', 'Ce panier de fruits BIO vous permettra de réaliser de belles salades de fruits.', NULL, NULL, 21.9, NULL, 3),
(30, 'fruits BIO (1 personne)', 'panier_fruit_petit.jpg', NULL, 12.5, 15, NULL, 1, 'Notre panier est composée de fruits BIO locales et parfois de fruits exotiques.\r\nSon poids est d\'environ 3 kilogrammes.', '1 panier d\'environ 3 kilogrammes.', 'Ce panier de fruits BIO est adapté la consommation d\'une personne pour environ une semaine.', NULL, NULL, 15, NULL, 3),
(31, 'fruits BIO grande famille', 'panier_fruit_grand.jpg', NULL, 30.42, 36.5, NULL, 1, 'Notre panier de fruits BIO de saison et parfois de fruits exotiques pèse de 7 à 8 kilogrammes.  ', '1 panier de 7 à 8 kilogrammes', 'Ce panier de fruits BIO conviendra à toutes les familles qui pourront déguster des fruits savoureux et variées autour d\'un bon repas et dans une atmosphère conviviale.', NULL, NULL, 36.5, NULL, 3);
